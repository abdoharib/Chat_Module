...
const _rules = require('../../config/Attribute_Rules');
const { Models } = require('../../../../custom/room/config');

const defaultAttr = [ "id", "latestUpdate","status" ] 

module.exports = class Rooms_Custom extends Room {
		...
		for (const CurrentParam of Models) {
          ...
          //  console.log(prop);
            ...
            if(prop.hasOwnProperty(CurrentParam.Name)){
                ...
                throw `The ${CurrentParam.Name} Attribuite is Required`;
            }
        }
    };
}
